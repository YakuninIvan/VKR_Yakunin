...
@dataclass
class DataConfig:
    dataset_dir = 'D:/VKR/Diploma_new/JEN-1-COMPOSER-pytorch/data'
    sr = 48000
    channels = 2
...
@dataclass
class ModelConfig: 
    in_channels = 284 #number of potential embedded channels to be entered
    channels = 284
    multipliers = [1, 1, 2, 2, 4, 4, 8] # indicates how many times the input channels of each block of UNet are in_channels. 
    factors = [1, 1, 1, 1, 1, 1] # convolution layer parameters for each block
    num_blocks = [1, 1, 1, 1, 1, 1] # number of ResNet Blocks in each block
    attentions = [0, 0, 0, 0, 0, 0] # number of Attention layers in each block
    patch_size = 1
    resnet_groups = 2
...
@dataclass
class Config:
    save_dir = 'D:/VKR/Diploma_new/JEN-1-COMPOSER-pytorch/save'
    log_dir = 'D:/VKR/Diploma_new/JEN-1-COMPOSER-pytorch/logs'
    use_ddp = False
    use_fp16 = False
    use_ema = False
    seed = 4996
